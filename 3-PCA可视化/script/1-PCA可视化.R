...
cat("正在读取PCA数据...\n")
# !注意：请根据实际数据路径修改以下路径
data <- read.csv("/mnt/f/OneDrive/科研/4_代码/2-Dimensionality-analysis/3-PCA可视化/data/China_lineage_pca_score.csv", header = TRUE)
...
# 创建PDF文件
#! 注意：请根据实际数据路径修改以下路径
pdf("/mnt/c/Users/Administrator/Desktop/China_lineage_PCA_plot.pdf", width = plot_params$pdf_width, height = plot_params$pdf_height)
